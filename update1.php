...
{	
	...
	$up_que="update firstsem set name='$name', enroll='$enroll', C='$first', DE='$second', BO='$third', EM='$fourth', CS='$fifth', C_pr='$sixth', DE_pr='$seventh', CS_pr='$eighth', total='$total', rem='$rem' where enroll='$enroll' ";
	$stmt=mysqli_query($con,$up_que);
	if($stmt){
	?>
	<html>
	<body>
