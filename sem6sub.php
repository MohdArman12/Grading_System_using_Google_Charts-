...
<tr>
<td>
<form action="Ecom.php">
<input type="submit" class="btn" value="E-Commerce">
</form></td>
<td><form action="DMW.php">
<input type="submit"  class="btn" value="DMW">
</form></td>
...
<td><form action="SC.php">
<input type="submit" class="btn" value="Secure Computing">
</form>
</td>
<td><form action="major.php">
<input type="submit" class="btn" value="Major Project">
</form>
</td>
</tr>
<tr>
<td colspan="2">
<form action="total6.php">
