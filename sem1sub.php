<html>
<link href="css/semsub.css" rel="stylesheet">
<head>
<style>
#icon{
float:right;
...
<td>
<form action="C.php">
<input type="submit" class="btn" value="C Language">
</form></td>
<td><form action="DE.php">
<input type="submit"  class="btn" value="Digital Electronics">
</form></td>
<td><form action="BO.php">
<input type="submit" class="btn" value="Business Organisation">
</form></td>
<td><form action="EM.php">
<input type="submit" class="btn" value="Elementary Maths">
</form></td>
</tr>
<tr>
<td><form action="CS.php">
<input type="submit" class="btn" value="Communication Skills">
</form></td>
<td><form action="Cpr.php">
<input type="submit" class="btn" value="C Practical">
</form>
</td>
<td><form action="DEpr.php">
<input type="submit" class="btn" value="DE Practical">
</form>
</td>
<td><form action="CSpr.php">
<input type="submit" class="btn" value="CS Practical">
</form>
</td>
</tr>
<tr>
<td colspan="4">
<form action="total1.php">
<input type="submit" class="btn" value="Total Marks">
</form>
</td>
</tr>
</table>
