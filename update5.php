...
{	
	...
	$up_que="update fifsem set name='$name', dob='$dob', enroll='$enroll', sem='$sem', Csharp='$first', WT='$second', OperationRes='$third', Egov='$fourth', SE='$fifth', Csharp_pr='$sixth', WT_pr='$seventh', SE_pr='$eighth', total='$total',rem='$rem' where enroll='$enroll'";
