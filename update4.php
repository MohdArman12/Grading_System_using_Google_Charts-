...
{	
	...
	$up_que="update fosem set name='$name', dob='$dob', enroll='$enroll', sem='$sem', java='$first', unix='$second', SAD='$third', CBNST='$fourth', GT='$fifth', java_pr='$sixth', unix_pr='$seventh', mini='$eighth', total='$total', rem='$rem' where enroll='$enroll'";
