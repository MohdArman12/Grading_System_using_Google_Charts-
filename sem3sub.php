...
<td><form action="DBMS.php">
<input type="submit"  class="btn" value="DBMS">
</form></td>
<td><form action="DCN.php">
<input type="submit" class="btn" value="DCN">
</form></td>
<td><form action="DAA.php">
<input type="submit" class="btn" value="DAA">
</form></td>
</tr>
<tr>
<td><form action="OS.php">
<input type="submit" class="btn" value="OS">
</form></td>
<td><form action="CPPpr.php">
<input type="submit" class="btn" value="C++ Practical">
</form>
</td>
<td><form action="DBMSpr.php">
<input type="submit" class="btn" value="DBMS Practical">
</form>
</td>
<td><form action="Colloquium.php">
<input type="submit" class="btn" value="Colloquium">
</form>
</td>
</tr>
<tr>
<td colspan="4">
<form action="total3.php">
