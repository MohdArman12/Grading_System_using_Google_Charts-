...
if($seventh){
	...
	else if($seventh>=46 && $seventh<=50){
		$g7="O";
	}
	else if($seventh>=43 && $seventh<=45){
		$g7="A+";
	}
	else if($seventh>=38 && $seventh<=42){
		$g7="A";
	}
	else if($seventh>=33 && $seventh<=37){
		$g7="B+";
	}
	else if($seventh>=28 && $seventh<=32){
		$g7="B";
	}
	else if($seventh>=23 && $seventh<=27){
		$g7="C";
	}
	else if($seventh>=17 && $seventh<=22){
		$g7="P";
	}
	else{
		$g7="F";
...
if($eighth){
	...
	else if($eighth>=91 && $eighth<=100){
		$g8="O";
	}
	else if($eighth>=86 && $eighth<=90){
		$g8="A+";
	}
	else if($eighth>=76 && $eighth<=85){
		$g8="A";
	}
	else if($eighth>=66 && $eighth<=75){
		$g8="B+";
	}
	else if($eighth>=56 && $eighth<=65){
		$g8="B";
	}
	else if($eighth>=46 && $eighth<=55){
		$g8="C";
	}
	else if($eighth>=33 && $eighth<=45){
		$g8="P";
	}
	else{
 		$g8="F";
...
$q="insert into fosem (name,dob,enroll,sem,java,unix,SAD,CBNST,GT,java_pr,unix_pr,mini,total,rem)values('$name','$dob','$enroll','$sem','$first','$second','$third','$fourth','$fifth','$sixth','$seventh','$eighth','$total','$rem')";
$q1="insert into grade4(name,enroll,java,unix,SAD,CBNST,GT,java_pr,unix_pr,mini,total)values('$name','$enroll','$g1','$g2','$g3','$g4','$g5','$g6','$g7','$g8','$tg')";
...
<input type="submit" id="btn" name="add4" value ="Continue">
</form>
</div>
</html>
<?php
