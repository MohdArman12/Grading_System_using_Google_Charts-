...
<td>
<form action="DS.php">
<input type="submit" class="btn" value="Data Structure">
</form></td>
<td><form action="DM.php">
<input type="submit"  class="btn" value="Discrete Maths">
</form></td>
<td><form action="FAM.php">
<input type="submit" class="btn" value="FAM">
</form></td>
<td><form action="COA.php">
<input type="submit" class="btn" value="COA">
</form></td>
</tr>
<tr>
<td><form action="EOS.php">
<input type="submit" class="btn" value="EOS">
</form></td>
<td><form action="DSpr.php">
<input type="submit" class="btn" value="DS Practical">
</form>
</td>
<td><form action="COApr.php">
<input type="submit" class="btn" value="COA Practical">
</form>
</td>
<td><form action="FAMpr.php">
<input type="submit" class="btn" value="FAM Practical">
</form>
</td>
</tr>
<tr>
<td colspan="4">
<form action="total2.php">
