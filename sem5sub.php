...
<tr>
<td>
<form action="Csharp.php">
<input type="submit" class="btn" value="C#">
</form></td>
<td><form action="WT.php">
<input type="submit"  class="btn" value="Web Technology">
</form></td>
<td><form action="OR.php">
<input type="submit" class="btn" value="Operations Research">
</form></td>
<td><form action="Egov.php">
<input type="submit" class="btn" value="E-Governance">
</form></td>
</tr>
<tr>
<td><form action="SE.php">
<input type="submit" class="btn" value="Software Engeering">
</form></td>
<td><form action="Csharppr.php">
<input type="submit" class="btn" value="C# Practical">
</form>
</td>
<td><form action="WTpr.php">
<input type="submit" class="btn" value="WT Practical">
</form>
</td>
<td><form action="SEpr.php">
<input type="submit" class="btn" value="SE Practical">
</form>
</td>
</tr>
<tr>
<td colspan="4">
<form action="total5.php">
