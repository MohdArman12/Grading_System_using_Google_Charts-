...
{
	$sel="select * from secsem where name='$user'";
	$res=mysqli_query($con,$sel);
	$row=mysqli_fetch_array($res);
	$sel2="select * from grade2 where name='$user'";
...
<g>
	...
	<tr><td>DS</td><td><?php echo $row2['DS'];?></td></tr>
	<tr><td>DM</td><td><?php echo $row2['DM'];?></td></tr>
	<tr><td>FAM</td><td><?php echo $row2['FAM'];?></td></tr>
	<tr><td>COA</td><td><?php echo $row2['COA'];?></td></tr>
	<tr><td>EOS</td><td><?php echo $row2['EOS'];?></td></tr>
	<tr><td>DS Practical</td><td><?php echo $row2['DS_pr'];?></td></tr>
	<tr><td>COA Practical</td><td><?php echo $row2['COA_pr'];?></td></tr>
	<tr><td>FAM Practical</td><td><?php echo $row2['FAM_pr'];?></td></tr>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ["DS", <?php echo $g1; ?>, "#FF0000"],
        ["DM", <?php echo $g2; ?>, "#FFA500"],
        ["FAM", <?php echo $g3; ?>, "#FFFF00"],
        ["COA",<?php echo $g4; ?>, "#ADFF2F"],
		["EOS",<?php echo $g5; ?>, "#228B22"],
		["DS pr",<?php echo $g6; ?>, "#0000FF"],
		["COA pr",<?php echo $g7; ?>, "#4B0082"],
		["FAM pr",<?php echo $g8; ?>, "#9400D3"]
      ]);
