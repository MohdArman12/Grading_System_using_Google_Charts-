...
{
	$sel="select * from firstsem where name='$user'";
	$res=mysqli_query($con,$sel);
	$row=mysqli_fetch_array($res);
	$sel2="select * from grade1 where name='$user'";
...
<g>
	...
	<tr><td>C Language</td><td><?php echo $row2['C'];?></td></tr>
	<tr><td>DE</td><td><?php echo $row2['DE'];?></td></tr>
	<tr><td>BO</td><td><?php echo $row2['BO'];?></td></tr>
	<tr><td>EM</td><td><?php echo $row2['EM'];?></td></tr>
	<tr><td>CS</td><td><?php echo $row2['CS'];?></td></tr>
	<tr><td>C Practical</td><td><?php echo $row2['C_pr'];?></td></tr>
	<tr><td>DE Practical</td><td><?php echo $row2['DE_pr'];?></td></tr>
	<tr><td>CS Practical</td><td><?php echo $row2['CS_pr'];?></td></tr>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ["DE", <?php echo $g2; ?>, "#FFA500"],
        ["BO", <?php echo $g3; ?>, "#FFFF00"],
		["EM",<?php echo $g4; ?>, "	#ADFF2F"],
		["CS",<?php echo $g5; ?>, "#228B22"],
		["C pr",<?php echo $g6; ?>, "#0000FF"],
		["DE pr",<?php echo $g7; ?>, "#4B0082"],
		["CS pr",<?php echo $g8; ?>, "#9400D3"]
      ]);
