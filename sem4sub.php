...
<input type="submit" class="btn" value="Java">
</form></td>
<td><form action="unix.php">
<input type="submit"  class="btn" value="Unix">
</form></td>
<td><form action="SAD.php">
<input type="submit" class="btn" value="SAD">
</form></td>
<td><form action="CBNST.php">
<input type="submit" class="btn" value="CBNST">
</form></td>
</tr>
<tr>
<td><form action="GT.php">
<input type="submit" class="btn" value="GT">
</form></td>
<td><form action="javapr.php">
<input type="submit" class="btn" value="Java Practical">
</form>
</td>
<td><form action="unixpr.php">
<input type="submit" class="btn" value="Unix Practical">
</form>
</td>
<td><form action="mini.php">
<input type="submit" class="btn" value="Mini Project">
</form>
</td>
</tr><tr><td colspan="4"><form action="total4.php"><input type="submit" class="btn" value="Total Marks"></form></td></tr>
</table>
</div>
</body>
</html>