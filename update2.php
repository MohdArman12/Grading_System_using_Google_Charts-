...
{	
	...
	$query="update secsem set name='$name', dob='$dob', enroll='$enroll', sem='$sem', DS='$first', DM='$second', FAM='$third', COA='$fourth', EOS='$fifth', DS_pr='$sixth', COA_pr='$seventh', FAM_pr='$eighth', total='$total', rem='$rem' where enroll='$enroll'";
