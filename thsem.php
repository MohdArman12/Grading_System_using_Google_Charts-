...
$q="insert into thsem (name,dob,enroll,sem,Cpp,DBMS,DCN,DAA,OS,Cpp_pr,DBMS_pr,colloquium,total,rem)values('$name','$dob','$enroll','$sem','$first','$second','$third','$fourth','$fifth','$sixth','$seventh','$eighth','$total','$rem')";
$q1="insert into grade3(name,enroll,Cpp,DBMS,DCN,DAA,OS,Cpp_pr,DBMS_pr,colloquium,total)values('$name','$enroll','$g1','$g2','$g3','$g4','$g5','$g6','$g7','$g8','$tg')";
...
<input type="submit" id="btn" name="add3" value ="Continue">
</form>
</div>
</html>
<?php
