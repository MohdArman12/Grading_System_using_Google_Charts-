...
$q="insert into secsem (name,dob,enroll,sem,DS,DM,FAM,COA,EOS,DS_pr,COA_pr,FAM_pr,total,rem)values('$name','$dob','$enroll','$sem','$first','$second','$third','$fourth','$fifth','$sixth','$seventh','$eighth','$total','$rem')";
$q1="insert into grade2(name,enroll,DS,DM,FAM,COA,EOS,DS_pr,COA_pr,FAM_pr,total)values('$name','$enroll','$g1','$g2','$g3','$g4','$g5','$g6','$g7','$g8','$tg')";
...
<input type="submit" id="btn" name="add2" value ="Continue">
</form>
</div>
</html>
<?php
