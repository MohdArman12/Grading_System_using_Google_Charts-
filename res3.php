...
{
	$sel="select * from thsem where name='$user'";
	$res=mysqli_query($con,$sel);
	$row=mysqli_fetch_array($res);
	$sel2="select * from grade3 where name='$user'";
...
<g>
	...
	<tr><td>C++</td><td><?php echo $row2['Cpp'];?></td></tr>
	<tr><td>DBMS</td><td><?php echo $row2['DBMS'];?></td></tr>
	<tr><td>DCN</td><td><?php echo $row2['DCN'];?></td></tr>
	<tr><td>DAA</td><td><?php echo $row2['DAA'];?></td></tr>
	<tr><td>OS</td><td><?php echo $row2['OS'];?></td></tr>
	<tr><td>C++ Practical</td><td><?php echo $row2['Cpp_pr'];?></td></tr>
	<tr><td>DBMS Practical</td><td><?php echo $row2['DBMS_pr'];?></td></tr>
	<tr><td>Colloquium</td><td><?php echo $row2['colloquium'];?></td></tr>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ["DBMS", <?php echo $g2; ?>, "#FFA500"],
        ["DCN", <?php echo $g3; ?>, "#FFFF00"],
        ["DAA",<?php echo $g4; ?>, "#ADFF2F"],
		["OS",<?php echo $g5; ?>, "#228B22"],
		["C++ pr",<?php echo $g6; ?>, "#0000FF"],
		["DBMS pr",<?php echo $g7; ?>, "#4B0082"],
		["colloquium",<?php echo $g8; ?>, "#9400D3"]
      ]);
